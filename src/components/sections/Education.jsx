            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {portfolioData.education.map((edu, index) => (
                    <BentoCard key={index} className="relative overflow-hidden group">
                        ...
                        <h3 className="text-xl font-bold text-text mb-1 font-sans">{edu.degree}</h3>
                        ...
                        <p className="text-text/70 text-sm mt-3 border-t border-black/5 pt-3 leading-relaxed">
                            {edu.description}
                        </p>
                    </BentoCard>
                ))}
